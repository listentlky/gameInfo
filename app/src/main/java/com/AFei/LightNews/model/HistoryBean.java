...
public class HistoryBean {
    ...
    @Generated(hash = 2017146388)
    public HistoryBean(Long id, String uniquekey, String title, String date, String category,
            String authorName, String url, String thumbnailPicS, String thumbnailPicS02,
